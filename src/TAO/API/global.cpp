...
namespace TAO::API
{
    ...
    void Initialize()
    {
        ...
        /* NOTE: LLP::API_SERVER is created in src/LLP/global.cpp, NOT here!
         * This function (TAO::API::Initialize) only registers API commands and initializes subsystems.
         * Creating the server in multiple locations causes port binding failures (duplicate bind to port 8080).
         * See src/LLP/global.cpp lines ~191-223 for the single, correct API_SERVER creation point. */
    }
