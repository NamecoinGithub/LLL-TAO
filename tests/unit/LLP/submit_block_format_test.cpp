...
TEST_CASE("SUBMIT_BLOCK Full Block Format Detection", "[submit_block]")
{
    ...
    SECTION("Constants are correctly defined")
    {
        ...
        REQUIRE(FalconConstants::SUBMIT_BLOCK_FULL_TRITIUM_HASH_WRAPPER_FALCON1024_MAX == 1803);
        REQUIRE(FalconConstants::SUBMIT_BLOCK_FULL_TRITIUM_HASH_WRAPPER_FALCON1024_ENCRYPTED_MAX == 1831);
        REQUIRE(FalconConstants::SUBMIT_BLOCK_FULL_TRITIUM_PRIME_WRAPPER_FALCON1024_MIN == 1803);
