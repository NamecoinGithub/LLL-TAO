...
- **[audit/pr697-production-regression-hotfix.md](audit/pr697-production-regression-hotfix.md)** - PR #697 production regression hotfix flow (immediate missing-tx trigger + no-progress backoff)
